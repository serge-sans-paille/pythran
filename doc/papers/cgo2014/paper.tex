...
compiler and provides a benchmarks test suite for performance measures along
several Python compilers.
Section~\ref{sec:stackoverflow} presents a case study based on user
input gathered on the StackOverflow questions and answers website.
...
in Section~\ref{sec:compilers}. Section~\ref{sec:pythran} emphasises on a
...
The fact that in Numpy, high-level constructs run faster is also a strong 
