...
enhance Python performance. However Shed~Skin does not provide support for the
Numpy module. The is an important work in progress from the PyPy community to
support Numpy, but it implies a partial rewrite of the Numpy API in RPython,
the language used by PyPy, to enable PyPy's optimization.
