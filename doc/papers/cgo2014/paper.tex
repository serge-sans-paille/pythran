...
Pythran keeps the static compilation approach used by Cython---JIT compilation
is mainly used to statically type kernels before code generation by Numba and
parakeet. Unlike Cython, it maintains full Python backward compatibility.
Following the Parakeet approach, it focuses on high-level constructs, while
still generating efficient code for explicit loop and subscripts.
  ...
  return bar(r, r[0])
    ...
    \begin{subfigure}{.5\textwidth}
        ...
        \begin{tikzpicture}[node/.style={rectangle, draw=black}]
            ...
            \draw[->] (bar.east) node[right, yshift=-1em] {(1)} -| ($(bar.east) + (.5,.75)$) node[right, yshift=-.8em] {$(\texttt{n,n})$} -| ($(bar.north) + (.5,0)$) ;
...
%\todo{I think a specific section could be made on this topic} SG: I lack time
...
%Finally, Figure~\ref{fig:l2norme} and \ref{fig:l2norm_intel8} illustrate the
%execution time for the \texttt{l2norm} kernel introduced in
%\S~\ref{sec:stackoverflow}. Comparison with other compilers shows that the
%approach taken by Pythran is relevant for these kind of functions. Just like
%for the \texttt{arc\_distance} benchmark, we notice the benefits of using the
%AVX instruction set when available.
%
%\begin{figure}[t]
%\centering
...
\hline
\hline
         allpairs\_distances &   58293 &             N/A &          3170 &   59232 & \textbf{1583} \\
  allpairs\_distances\_loops &   64137 &         72748 &          3158 &   65287 & \textbf{3146} \\
               arc\_distance &    2796 &          2792 &          3084 &    2791 &  \textbf{103} \\
                        conv & 3260079 &             N/A & \textbf{3284} & 3268298 &          3420 \\
                create\_grid &    5231 & \textbf{5044} &             N/A &    5240 &          5587 \\
                    cronbach &    1905 &          2016 &             N/A &    1909 & \textbf{1890} \\
                   diffusion &   42998 &         45030 & \textbf{8843} &   43238 &         21704 \\
                      evolve &    8236 &             N/A &             N/A &    8319 & \textbf{6242} \\
                        fdtd & 1940884 &       1498849 &             N/A & 2007839 & \textbf{2294} \\
                         fft &   27120 &             N/A &             N/A &   27009 & \textbf{2151} \\
                    grouping &    3739 &             N/A &             N/A &    3740 & \textbf{1747} \\
                     growcut & 2112332 &         11617 & \textbf{5485} & 2141571 &         10338 \\
                      harris &    7173 &          9116 & \textbf{4240} &    7322 &          4889 \\
                     hyantes &  288852 &             N/A & \textbf{2834} &  289074 &          3522 \\
                       julia & 1744357 &          5168 &  \textbf{109} & 1771329 &          4255 \\
                      l2norm &    5966 &          5948 &          9210 &    6559 &  \textbf{551} \\
               local\_maxima &  132237 &             N/A &             N/A &  132047 & \textbf{8561} \\
