...
writes $i$, any outgoing edge $(i, j)$ can be safely removed, as we know for
...
to evaluate these optimizations. It is use with Pythran (commit: 488b7ba)
...
the Intel8 architecture while AMD48 support up to SSE4 only.
