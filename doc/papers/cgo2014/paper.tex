...
on Listing~\ref{lst:rosen} and input is a raw array of 1,000,000 of double elements.
...
support AVX. This program also benefits from OpenMP. Input is 10000 elements 
double raw array.

%FIXME: mehdi propose de n'utiliser qu'un backend pour centrer le propos sur Pythran/Numpy.
% ça allègera aussi les graphes...
% On change juste le jeu de donnée plutot que de supprimer une archi
