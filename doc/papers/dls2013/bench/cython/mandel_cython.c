/* Generated by Cython 0.15.1 on Mon Feb 11 15:34:03 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cmandel
#define __PYX_HAVE_API__cmandel
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_double_t __pyx_t_7cmandel_DTYPE_t;
...
/* Module declarations from 'cmandel' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_7cmandel_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_7cmandel_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "cmandel"
int __pyx_module_is_main_cmandel = 0;

/* Implementation of 'cmandel' */
...
static char __pyx_k__cmandel[] = "cmandel";
...
static PyObject *__pyx_n_s__cmandel;
...
static PyObject *__pyx_pf_7cmandel_mandel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7cmandel_mandel = {__Pyx_NAMESTR("mandel"), (PyCFunction)__pyx_pf_7cmandel_mandel, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_7cmandel_mandel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_size;
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("mandel", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__y_center);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mandel", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__max_iteration);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mandel", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "mandel") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_size = __Pyx_PyInt_AsInt(values[0]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_x_center = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_x_center == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_y_center = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_y_center == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_max_iteration = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_max_iteration == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mandel", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cmandel.mandel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_out.buf = NULL;

  /* "mandel_cython.pyx":12
 *     cdef int i, j, iteration, color_value
 *     cdef double x, y, a, b
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromLong(__pyx_v_size); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_7cmandel_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 * 
 */
      __pyx_t_10 = (4.0 * ((double)(__pyx_v_i - __Pyx_div_long(__pyx_v_size, 2))));
      if (unlikely(__pyx_v_size == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_x = (__pyx_v_x_center + (__pyx_t_10 / __pyx_v_size));

      /* "mandel_cython.pyx":16
 *         for j in xrange(size):
 *             x = x_center + 4.0*float(i-size/2)/size
 *             y = y_center + 4.0*float(j-size/2)/size             # <<<<<<<<<<<<<<
 * 
 *             a = 0.0
 */
      __pyx_t_10 = (4.0 * ((double)(__pyx_v_j - __Pyx_div_long(__pyx_v_size, 2))));
      if (unlikely(__pyx_v_size == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_y = (__pyx_v_y_center + (__pyx_t_10 / __pyx_v_size));

      /* "mandel_cython.pyx":18
 *             y = y_center + 4.0*float(j-size/2)/size
 * 
 *             a = 0.0             # <<<<<<<<<<<<<<
 *             b = 0.0
 ...
 *     return out
 */
        __pyx_v_color_value = __Pyx_mod_long((__pyx_v_iteration * 10), 255);
      }
      __pyx_L12:;

      /* "mandel_cython.pyx":30
 *             else:
 *                 color_value = iteration*10 % 255
 *             out[i,j]=color_value             # <<<<<<<<<<<<<<
 *     return out
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_7cmandel_DTYPE_t *, __pyx_bstruct_out.buf, __pyx_t_14, __pyx_bstride_0_out, __pyx_t_15, __pyx_bstride_1_out) = __pyx_v_color_value;
    }
  }

  /* "mandel_cython.pyx":31
 *                 color_value = iteration*10 % 255
 *             out[i,j]=color_value
 *     return out             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cmandel, __pyx_k__cmandel, sizeof(__pyx_k__cmandel), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcmandel(void); /*proto*/
PyMODINIT_FUNC initcmandel(void)
#else
PyMODINIT_FUNC PyInit_cmandel(void); /*proto*/
PyMODINIT_FUNC PyInit_cmandel(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cmandel(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cmandel"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_cmandel) {
 ...
 *     cdef double x, y, a, b
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7cmandel_mandel, NULL, __pyx_n_s__cmandel); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__mandel, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cmandel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cmandel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
