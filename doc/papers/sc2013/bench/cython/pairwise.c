/* Generated by Cython 0.15.1 on Mon Feb 11 15:34:07 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cpairwise
#define __PYX_HAVE_API__cpairwise
#include "math.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_double_t __pyx_t_9cpairwise_DTYPE_t;
...
/* Module declarations from 'cpairwise' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_9cpairwise_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_9cpairwise_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "cpairwise"
int __pyx_module_is_main_cpairwise = 0;

/* Implementation of 'cpairwise' */
...
static char __pyx_k__cpairwise[] = "cpairwise";
...
static PyObject *__pyx_n_s__cpairwise;
...
static PyObject *__pyx_pf_9cpairwise_pairwise(PyObject *__pyx_self, PyObject *__pyx_v_X); /*proto*/
static PyMethodDef __pyx_mdef_9cpairwise_pairwise = {__Pyx_NAMESTR("pairwise"), (PyCFunction)__pyx_pf_9cpairwise_pairwise, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_9cpairwise_pairwise(PyObject *__pyx_self, PyObject *__pyx_v_X) {
  long __pyx_v_i;
  long __pyx_v_j;
  long __pyx_v_k;
  long __pyx_v_M;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_5numpy_ndarray, 1, "X", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_X, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_9cpairwise_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_D, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_9cpairwise_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
        ...
        __pyx_v_tmp = ((*__Pyx_BufPtrStrided2d(__pyx_t_9cpairwise_DTYPE_t *, __pyx_bstruct_X.buf, __pyx_t_12, __pyx_bstride_0_X, __pyx_t_13, __pyx_bstride_1_X)) - (*__Pyx_BufPtrStrided2d(__pyx_t_9cpairwise_DTYPE_t *, __pyx_bstruct_X.buf, __pyx_t_14, __pyx_bstride_0_X, __pyx_t_15, __pyx_bstride_1_X)));
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_9cpairwise_DTYPE_t *, __pyx_bstruct_D.buf, __pyx_t_10, __pyx_bstride_0_D, __pyx_t_11, __pyx_bstride_1_D) = sqrt(__pyx_v_d);
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("cpairwise.pairwise", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_X);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cpairwise, __pyx_k__cpairwise, sizeof(__pyx_k__cpairwise), 0, 0, 1, 1},
...
static int __Pyx_InitCachedBuiltins(void) {
  #if PY_MAJOR_VERSION >= 3
  __pyx_builtin_xrange = __Pyx_GetName(__pyx_b, __pyx_n_s__range); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #else
  __pyx_builtin_xrange = __Pyx_GetName(__pyx_b, __pyx_n_s__xrange); if (!__pyx_builtin_xrange) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcpairwise(void); /*proto*/
PyMODINIT_FUNC initcpairwise(void)
#else
PyMODINIT_FUNC PyInit_cpairwise(void); /*proto*/
PyMODINIT_FUNC PyInit_cpairwise(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cpairwise(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cpairwise"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_cpairwise) {
 ...
 *     cdef double d, tmp
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9cpairwise_pairwise, NULL, __pyx_n_s__cpairwise); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__pairwise, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cpairwise", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cpairwise");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
