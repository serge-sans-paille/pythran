...
% FIXME as noted by reviewer 4, the previous sentence is not exact. Just a few
% lines above we said that "tuple unpacking is turned in multiple assignments"
...
% FIXME reviewer 4 doesn't seem to agree with and/or C++ vs Python
