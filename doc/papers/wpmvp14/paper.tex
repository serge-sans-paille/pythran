...
\begin{lstlisting}[language=python, label={lst:euler06-py}, caption={Solution to the Project Euler Sixth Problem in Python}]
def solve();
  r = xrange(1, 101)
  a = sum(r)
...
\begin{lstlisting}[language=c, label={lst:euler06-c}, caption={Solution to the Project Euler Sixth Problem in C}]
size_t solve() {
  size_t a = 0, s = 0;
