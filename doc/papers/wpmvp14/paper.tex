...
typing. It compilation frow is described in Figure~\ref{fig:pythran-compiler}.
Like other AOT compilers, it unboxes all variables for better performance, and
