...
C++17 modules. From a user point of view, you still ``import`` your module, but
...
You also need a modern C++17 enabled compiler.
...
:``cflags``:
    ...
    go there. The default is to set ``-std=c++17`` for C++17 support.
