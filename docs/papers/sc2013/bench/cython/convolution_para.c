/* Generated by Cython 0.15.1 on Mon Feb 11 15:34:00 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cconvolution_omp
#define __PYX_HAVE_API__cconvolution_omp
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_double_t __pyx_t_16cconvolution_omp_DTYPE_t;
...
/* Module declarations from 'cconvolution_omp' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_16cconvolution_omp_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_16cconvolution_omp_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "cconvolution_omp"
int __pyx_module_is_main_cconvolution_omp = 0;

/* Implementation of 'cconvolution_omp' */
...
static char __pyx_k__cconvolution_omp[] = "cconvolution_omp";
...
static PyObject *__pyx_n_s__cconvolution_omp;
...
static PyObject *__pyx_pf_16cconvolution_omp_convolution(PyObject *__pyx_self, PyObject *__pyx_v_A); /*proto*/
static PyMethodDef __pyx_mdef_16cconvolution_omp_convolution = {__Pyx_NAMESTR("convolution"), (PyCFunction)__pyx_pf_16cconvolution_omp_convolution, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_16cconvolution_omp_convolution(PyObject *__pyx_self, PyObject *__pyx_v_A) {
  int __pyx_v_m;
  int __pyx_v_n;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_A), __pyx_ptype_5numpy_ndarray, 1, "A", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_A, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_16cconvolution_omp_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_m); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromLong(__pyx_v_n); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_B, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_16cconvolution_omp_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  {
      ...
      /*try:*/ {
        {
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_10, __pyx_t_6, __pyx_t_28, __pyx_t_25, __pyx_t_30, __pyx_t_14, __pyx_t_19, __pyx_t_22, __pyx_t_13, __pyx_t_18, __pyx_t_26, __pyx_t_17, __pyx_t_9, __pyx_t_7, __pyx_t_29, __pyx_t_23, __pyx_t_12, __pyx_t_20, __pyx_t_27, __pyx_t_11, __pyx_t_16, __pyx_t_21, __pyx_t_24, __pyx_t_8, __pyx_t_15)
            #endif /* _OPENMP */
            {

                /* "convolution_para.pyx":26
 *     cdef int i,j
 *     with nogil, parallel():
 *         for i in prange(1, m - 1):             # <<<<<<<<<<<<<<
 *             for j in xrange(1, n - 1):
 ...
 */
  ...
  __Pyx_AddTraceback("cconvolution_omp.convolution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_A);
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __Pyx_NAMESTR("cconvolution_omp"),
    0, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cconvolution_omp, __pyx_k__cconvolution_omp, sizeof(__pyx_k__cconvolution_omp), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcconvolution_omp(void); /*proto*/
PyMODINIT_FUNC initcconvolution_omp(void)
#else
PyMODINIT_FUNC PyInit_cconvolution_omp(void); /*proto*/
PyMODINIT_FUNC PyInit_cconvolution_omp(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cconvolution_omp(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cconvolution_omp"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_cconvolution_omp) {
 ...
 *     cdef int n = A.shape[1]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_16cconvolution_omp_convolution, NULL, __pyx_n_s__cconvolution_omp); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__convolution, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cconvolution_omp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cconvolution_omp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
