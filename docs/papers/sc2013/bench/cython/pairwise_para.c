...
#endif
#include <math.h>
#define __PYX_HAVE__cpairwise_omp
#define __PYX_HAVE_API__cpairwise_omp
#include "math.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_double_t __pyx_t_13cpairwise_omp_DTYPE_t;
...
/* Module declarations from 'cpairwise_omp' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_13cpairwise_omp_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_13cpairwise_omp_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "cpairwise_omp"
int __pyx_module_is_main_cpairwise_omp = 0;

/* Implementation of 'cpairwise_omp' */
...
static char __pyx_k__cpairwise_omp[] = "cpairwise_omp";
...
static PyObject *__pyx_n_s__cpairwise_omp;
...
static PyObject *__pyx_pf_13cpairwise_omp_pairwise(PyObject *__pyx_self, PyObject *__pyx_v_X); /*proto*/
static PyMethodDef __pyx_mdef_13cpairwise_omp_pairwise = {__Pyx_NAMESTR("pairwise"), (PyCFunction)__pyx_pf_13cpairwise_omp_pairwise, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_13cpairwise_omp_pairwise(PyObject *__pyx_self, PyObject *__pyx_v_X) {
  long __pyx_v_i;
  long __pyx_v_j;
  long __pyx_v_k;
  long __pyx_v_M;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("pairwise");
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_5numpy_ndarray, 1, "X", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_X, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_13cpairwise_omp_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_v_M = (((PyArrayObject *)__pyx_v_X)->dimensions[0]);

  /* "pairwise_para.pyx":19
 *     cdef double d, tmp
 *     M = X.shape[0]
 *     N = X.shape[1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=2, negative_indices=False] D = np.zeros((M,N))
 *     with nogil, parallel():
 */
  __pyx_v_N = (((PyArrayObject *)__pyx_v_X)->dimensions[1]);

  /* "pairwise_para.pyx":20
 *     M = X.shape[0]
 *     N = X.shape[1]
 *     cdef np.ndarray[DTYPE_t, ndim=2, negative_indices=False] D = np.zeros((M,N))             # <<<<<<<<<<<<<<
 *     with nogil, parallel():
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_M); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_4 = 0;
  __pyx_t_4 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_D, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_13cpairwise_omp_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  {
      ...
      /*try:*/ {
        {
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_13, __pyx_t_12, __pyx_t_6, __pyx_t_11, __pyx_t_16, __pyx_t_9, __pyx_t_7, __pyx_t_8, __pyx_t_14, __pyx_t_10, __pyx_t_15)
            #endif /* _OPENMP */
            {

                /* "pairwise_para.pyx":22
 *     cdef np.ndarray[DTYPE_t, ndim=2, negative_indices=False] D = np.zeros((M,N))
 *     with nogil, parallel():
 *         for i in prange(M):             # <<<<<<<<<<<<<<
 *             for j in xrange(M):
 ...
 */
                ...
                if (1 == 0) abort();
                {
                    ...
                    if (__pyx_t_8 > 0)
                    {
                        __pyx_v_i = 0;
                        #ifdef _OPENMP
                        #pragma omp for lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_k) lastprivate(__pyx_v_j) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_d)
                        #endif /* _OPENMP */
 ...
 */
                                    ...
                                    __pyx_v_tmp = ((*__Pyx_BufPtrStrided2d(__pyx_t_13cpairwise_omp_DTYPE_t *, __pyx_bstruct_X.buf, __pyx_t_13, __pyx_bstride_0_X, __pyx_t_14, __pyx_bstride_1_X)) - (*__Pyx_BufPtrStrided2d(__pyx_t_13cpairwise_omp_DTYPE_t *, __pyx_bstruct_X.buf, __pyx_t_15, __pyx_bstride_0_X, __pyx_t_16, __pyx_bstride_1_X)));

                                    /* "pairwise_para.pyx":27
 *                 for k in xrange(N):
 *                     tmp = X[i,k] - X[j,k]
 *                     d = d + tmp * tmp             # <<<<<<<<<<<<<<
 *                 D[i,j] = sqrt(d)
 ...
 */
                                  ...
                                  *__Pyx_BufPtrStrided2d(__pyx_t_13cpairwise_omp_DTYPE_t *, __pyx_bstruct_D.buf, __pyx_t_11, __pyx_bstride_0_D, __pyx_t_12, __pyx_bstride_1_D) = sqrt(__pyx_v_d);
                                }
                            }
                        }
                    }
 ...
 */
  ...
  __Pyx_AddTraceback("cpairwise_omp.pairwise", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_X);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cpairwise_omp, __pyx_k__cpairwise_omp, sizeof(__pyx_k__cpairwise_omp), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcpairwise_omp(void); /*proto*/
PyMODINIT_FUNC initcpairwise_omp(void)
#else
PyMODINIT_FUNC PyInit_cpairwise_omp(void); /*proto*/
PyMODINIT_FUNC PyInit_cpairwise_omp(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cpairwise_omp(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cpairwise_omp"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_cpairwise_omp) {
 ...
 *     cdef double d, tmp
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13cpairwise_omp_pairwise, NULL, __pyx_n_s__cpairwise_omp); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__pairwise, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cpairwise_omp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cpairwise_omp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
