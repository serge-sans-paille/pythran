            ...
            namespace {
                template<typename... BoundedTypes>
                    struct bounded {
                        ...
                        bounded(BoundedTypes... types) : params(types...)
                        {
                        }

                        template<int...S, typename... Types>
                            auto call(seq<S...>, Types &&... types) const
                            -> decltype(std::get<0>(params)(std::get<S>(params)..., std::forward<Types>(types)...))
                            {
                        ...
                        template<typename... Types>
                            ...
                            -> decltype(this->call(typename gens<sizeof...(BoundedTypes)>::type(), std::forward<Types>(types)...))
                            {
