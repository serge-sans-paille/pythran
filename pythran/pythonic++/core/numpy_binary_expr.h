...
typename std::enable_if<is_numexpr_arg<typename std::remove_cv<typename std::remove_reference<E0>::type>::type>::value
                            and is_numexpr_arg<typename std::remove_cv<typename std::remove_reference<E1>::type>::type>::value,
                        numpy_expr<NUMPY_BINARY_FUNC_SYM, E0, E1>
                       >::type NUMPY_BINARY_FUNC_NAME(E0 && self, E1 && other)
{
...
typename std::enable_if<is_numexpr_arg<typename std::remove_cv<typename std::remove_reference<E>::type>::type>::value
                            and std::is_scalar<S>::value,
                        numpy_expr<NUMPY_BINARY_FUNC_SYM, E,  broadcast<S>>
                       >::type NUMPY_BINARY_FUNC_NAME(E && self, S other)
{
...
typename std::enable_if<is_numexpr_arg<typename std::remove_cv<typename std::remove_reference<E>::type>::type>::value
                       ...
                       >::type NUMPY_BINARY_FUNC_NAME(S other, E && self)
{
