...
namespace pythonic {
    ...
    namespace core {
        ...
        public:
            ...
            set<T> operator+(core::empty_set const &)
            {
                return copy();
            }
            ...
            template<class U>
            set<T> operator+(core::set<U> const &other)
            {
                return union_(other);
            }
            ...
            set<T> symmetric_difference(set<U> const& other) const
            {
                ...
                //We must use fcts and not operators because fcts have to handle any itarable objects and operators only sets (cf python ref)
        ...
        struct empty_set {
            ...
            template<class T>
            empty_set operator&(set<T> const & s)
            {
                return empty_set();
            }
            empty_set operator-(empty_set const &)
