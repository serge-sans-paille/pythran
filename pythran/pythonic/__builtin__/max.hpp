...
namespace pythonic
{
  ...
  namespace __builtin__
  {
    ...
    template <class T0>
    typename _max<true, T0>::result_type _max<true, T0>::operator()(T0 &&t)
    {
      return *std::max_element(t.begin(), t.end());
    }

    template <class T0>
    typename _max<false, T0>::result_type _max<false, T0>::
    operator()(T0 const &t)
    {
      return t;
    }
    ...
    typename _max<false, T0, T1>::result_type _max<false, T0, T1>::
    ...
    typename _max<false, T0, Types...>::result_type _max<false, T0, Types...>::
    ...
    max(Types &&... values)
    {
      return _max<sizeof...(Types) == 1, Types...>()(
