...
namespace pythonic
{
  ...
  namespace __builtin__
  {
    ...
    template <class T0>
    typename _min<true, T0>::result_type _min<true, T0>::operator()(T0 &&t)
    {
      return *std::min_element(t.begin(), t.end());
    }

    template <class T0>
    typename _min<false, T0>::result_type _min<false, T0>::
    operator()(T0 const &t)
    {
      return t;
    }
    ...
    typename _min<false, T0, T1>::result_type _min<false, T0, T1>::
    ...
    typename _min<false, T0, Types...>::result_type _min<false, T0, Types...>::
    ...
    min(Types &&... values)
    {
      return _min<sizeof...(Types) == 1, Types...>()(
