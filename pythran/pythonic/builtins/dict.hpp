...
inline PyObject *
to_python<builtins::functor::dict>::convert(builtins::functor::dict const &c)
{
...
inline builtins::functor::dict
from_python<builtins::functor::dict>::convert(PyObject *obj)
{
  return {};
}
