...
inline PyObject *
to_python<builtins::functor::float_>::convert(builtins::functor::float_ const &c)
{
...
inline builtins::functor::float_
from_python<builtins::functor::float_>::convert(PyObject *obj)
{
  return {};
}
