...
namespace pythonic {
    ...
    namespace itertools {
        template <typename Iterable>
            struct islice_iterator : std::iterator<typename Iterable::iterator::iterator_category,
                                                   typename Iterable::iterator::value_type >
            {
                ...
                islice_iterator(npos const& n, Iterable const & iterable, __builtin__::xrange const& xr);
        ...
        template <typename Iterable>
            _islice<typename std::remove_cv<typename std::remove_reference<Iterable>::type>::type>
