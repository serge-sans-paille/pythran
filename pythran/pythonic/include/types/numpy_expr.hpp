...
namespace pythonic {
    ...
    namespace types {
        ...
        template<class Op, class... Args>
            struct numpy_expr {
                ...
                using value_type = decltype(Op()(std::declval<typename std::remove_reference<Args>::type::value_type>()...));
                using dtype = decltype(Op()(std::declval<typename std::remove_reference<Args>::type::dtype>()...));
    ...
    template<class Op, class... Arg>
        ...
        {
            using type = typename types::numpy_expr_to_ndarray<types::numpy_expr<Op, Arg...>>::type;
        };
...
template<class Op, class Op2, class... Args, class... Args2>
    ...
    {
        using type = typename pythonic::types::numpy_expr_to_ndarray<pythonic::types::numpy_expr<Op, Args...>>::type;
    };
