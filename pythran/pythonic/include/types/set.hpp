    ...
    namespace types {
        ...
        template<class T>
            class set {
                ...
                // data holder
                using _type = typename std::remove_cv< typename std::remove_reference<T>::type>::type;
                ...
                using iterator = utils::comparable_iterator<typename container_type::iterator>;
                using const_iterator = utils::comparable_iterator<typename container_type::const_iterator>;
                ...
                template<typename U, typename... Types>
                    set<T>
                    difference(U const& other, Types const&... others) const;
                ...
                template <class U>
                friend
                std::ostream& operator<<(std::ostream& os, set<U> const & v);
            };
