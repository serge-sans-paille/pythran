...
namespace pythonic {
    ...
    namespace types {
        ...
        */
        template<class T, bool scalar = std::is_scalar<T>::value or is_complex<T>::value>
            struct is_vectorizable_array;

        template<class T>
            struct is_vectorizable_array<T, true> : std::integral_constant<bool, false>
            {};

        template<class T>
            struct is_vectorizable_array<T, false> : std::integral_constant<bool, T::is_vectorizable>
            {};
