...
namespace pythonic
{
  ...
  namespace itertools
  {
    ...
    template <class T>
    typename _combination<T>::iterator const &_combination<T>::begin() const
    {
      return *this;
    }

    template <class T>
    typename _combination<T>::iterator _combination<T>::begin()
    {
      return *this;
    }

    template <class T>
    typename _combination<T>::iterator _combination<T>::end() const
    {
