...
namespace pythonic {
    ...
    namespace numpy {
        ...
        template<class dtype>
            types::ndarray<typename types::numpy_type<dtype>::type, 2> eye(long N, long M, long k, dtype d)
            {
        ...
        template<class dtype>
            types::ndarray<typename types::numpy_type<dtype>::type, 2> eye(long N, types::none_type M, long k, dtype d)
            {
                return eye(N, N, k, d);
            }
