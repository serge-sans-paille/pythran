...
inline PyObject *
to_python<numpy::functor::float128>::convert(numpy::functor::float128 const &c)
{
...
inline numpy::functor::float128
from_python<numpy::functor::float128>::convert(PyObject *obj)
{
  return {};
}
