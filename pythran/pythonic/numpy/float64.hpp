...
inline PyObject *
to_python<numpy::functor::float64>::convert(numpy::functor::float64 const &c)
{
...
inline numpy::functor::float64
from_python<numpy::functor::float64>::convert(PyObject *obj)
{
  return {};
}
