...
namespace pythonic {
    ...
    namespace numpy {
        ...
        template<class F, class dtype, class purity_tag>
            ...
            fromfunction_helper<F,1,dtype, purity_tag>::operator()(F&& f, types::array<long,1> const& shape, dtype d)
            {
        ...
        template<class F, class dtype, class purity_tag>
            ...
            fromfunction_helper<F,2,dtype, purity_tag>::operator()(F&& f, types::array<long,2> const& shape, dtype d)
            {
