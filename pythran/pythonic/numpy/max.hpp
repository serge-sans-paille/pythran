...
namespace pythonic {
    ...
    namespace numpy {
        ...
        template<class T, size_t N>
            typename types::ndarray<T,N>::value_type max(types::ndarray<T,N> const& array, long axis)
            {
                ...
                else
                {
                    ...
                    std::transform(array.begin(), array.end(), miny.begin(), [=](types::ndarray<T,N-1> const& other) {return max(other, axis-1);});
                    return miny;
                }
            }
