    ...
    namespace types {
        ...
        template<class E>
            numpy_texpr_2<E>::numpy_texpr_2(Arg const& arg) :
                arg(arg),
                _shape{{arg.shape()[1], arg.shape()[0]}}
            {}

        template<class E>
            typename numpy_texpr_2<E>::const_iterator
            numpy_texpr_2<E>::begin() const
            {
                return {*this, 0};
            }
        ...
        template<class E>
            auto numpy_texpr_2<E>::operator[](long i) const
        ...
        template<class E>
            auto numpy_texpr_2<E>::operator[](array<long, numpy_texpr_2<E>::value> const& indices)
        ...
        template<class E>
            auto numpy_texpr_2<E>::operator[](array<long, numpy_texpr_2<E>::value> const& indices) const
            -> decltype(arg[array<long, 2>{{indices[1], indices[0]}}])
            {
                return arg[array<long, 2>{{indices[1], indices[0]}}];
            }
        ...
        template<class S, int... I>
            auto numpy_texpr_2<E>::_reverse_index(S const& indices, utils::seq<I...>) const
