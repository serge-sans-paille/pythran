...
namespace pythonic {
    ...
    namespace types {
        ...
        template<class T, size_t N>
            auto to_tuple_impl<I>::operator()(types::array<T,N> const& l) const
        ...
        template<class T, size_t N>
            std::tuple<T>
            to_tuple_impl<1>::operator()(types::array<T,N> const& l) const
            {
        ...
        template<class T, size_t N>
            std::tuple<>
            to_tuple_impl<0>::operator()(types::array<T,N> const& l) const
            {
                return std::tuple<T>();
            }
        ...
        template<int Offset, class T, int... N>
            ...
            -> decltype(std::make_tuple(std::get<Offset + N>(t)...))
            {
