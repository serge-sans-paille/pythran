    ...
    namespace types {
        ...
        template<class T, size_t N, class... Types>
          struct alike<std::tuple<Types...>, array<T,N>> {
            ...
            static_assert(value or not std::is_same<T, types::str>::value,
                          "either the tuple and the array are *not* alike, or they are alike, and in that case we would have a str somewhere");
          };
        template<class T, size_t N, class... Types>
