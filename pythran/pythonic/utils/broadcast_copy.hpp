...
namespace pythonic {
    ...
    namespace utils {
        ...
        template <class E, class F, size_t N>
            void _broadcast_copy<vector_form>::operator()(E &&self, F const &other, utils::int_<N>, utils::int_<0>)
            {
...
#pragma omp parallel for
        ...
        template <class E, class F, size_t N, size_t D>
            void _broadcast_copy<vector_form>::operator()(E &&self, F const &other, utils::int_<N>, utils::int_<D>)
            {
                self.fast(0) = other;
#ifdef _OPENMP
                long n = self.shape[0];
...
#pragma omp parallel for
        ...
        template <class E, class F>
            void _broadcast_copy<true>::operator()(E &&self, F const &other, utils::int_<1>, utils::int_<0>)
            {
...
#pragma omp parallel for
        ...
        template <class E, class F, size_t N>
            void _broadcast_copy<true>::operator()(E &&self, F const &other, utils::int_<N>, utils::int_<0>)
            {
                long self_size = std::distance(self.begin(), self.end()),
                     other_size = std::distance(other.begin(), other.end());
                if (other_size > 0) // empty array sometimes happen when filtering
...
#pragma omp parallel for
        ...
        // ``D'' is not ``0'' so we should broadcast
        template <class E, class F, size_t N, size_t D>
            void _broadcast_copy<true>::operator()(E &&self, F const &other, utils::int_<N>, utils::int_<D>)
            {
