...
struct __combined<indexable<K>, core::ltuple<T,N>> {
    typedef core::ltuple<T,N> type;
};

template<class K, class T, size_t N>
struct __combined<core::ltuple<T,N>, indexable<K>> {
    typedef core::ltuple<T,N> type;
};

template<class K, class T, size_t N>
struct __combined<container<K>, core::ltuple<T,N>> {
    typedef core::ltuple<typename __combined<T,K>::type ,N> type;
};

template<class K, class T, size_t N>
struct __combined<core::ltuple<T,N>, container<K>> {
    typedef core::ltuple<typename __combined<T,K>::type ,N> type;
};
