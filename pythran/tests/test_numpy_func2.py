...
def test_copy0(x):
    ...
    def test_concatenate5(self):
        self.run_test("def np_concatenate5(x, y): from numpy import concat ; return concat((x, y), axis=-1)",
                      numpy.array([[1, 2], [3, 4]]),
                      numpy.array([[5, 6], [7, 8]]),
                      np_concatenate5=[NDArray[int,:,:], NDArray[int,:,:]])

    def test_concatenate6(self):
        self.run_test("def np_concatenate6(x, y): from numpy import concat ; return concat((x, y, [[10], [11]]), axis=-1)",
                      numpy.array([[1, 2], [3, 4]]),
                      numpy.array([[5, 6], [7, 8]]),
                      np_concatenate6=[NDArray[int,:,:], NDArray[int,:,:]])
