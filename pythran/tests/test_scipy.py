...
"""
        ...
        self.run_test(code, m, 0.01, 0.02,
                      laplace=[List[List[float]], float, float])
...
def binary_search(seq, t):
    ...
    while 1:
        ...
        if seq[m] < t:
            ...
            return m
"""
        self.run_test(code, [1, 2, 3, 4, 5, 6, 7, 8, 9], 4,
                      binary_search=[List[int], int])
...
"""
        self.run_test(code, [0. for x in xrange(10)], 1.5, 9.5,
                      ramp=[List[float], float, float])
