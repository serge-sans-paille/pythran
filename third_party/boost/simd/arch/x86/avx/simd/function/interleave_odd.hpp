...
namespace boost { namespace simd { namespace ext
{
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0 & a0, const A0 & a1 ) const BOOST_NOEXCEPT
    {
      ...
      return  bitwise_cast<A0>(f_t( _mm256_unpackhi_pd( bitwise_cast<f_t>(a0)
                                                  , bitwise_cast<f_t>(a1)
                                                  )
                                  )
                              );
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0 & a0, const A0 & a1 ) const BOOST_NOEXCEPT
    {
      ...
      return  bitwise_cast<A0>(f_t( _mm256_unpackhi_ps( _mm256_shuffle_ps(b0, b0, _MM_SHUFFLE(3,1,2,0))
