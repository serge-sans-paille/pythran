...
namespace boost { namespace simd { namespace ext
{
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0 & a0, const A0 & a1 ) const BOOST_NOEXCEPT
    {
      ...
      return _mm256_permute4x64_epi64(_mm256_unpackhi_epi8(lh0, lh1), 0xD8);
    }
  };
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0 & a0, const A0 & a1 ) const BOOST_NOEXCEPT
    {
      ...
      auto h = _mm256_unpackhi_epi16(a0,a1);
           l = _mm256_unpackhi_epi16(_mm256_unpacklo_epi16(l,h), _mm256_unpackhi_epi16(l,h));
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0 & a0, const A0 & a1 ) const BOOST_NOEXCEPT
    {
      auto l = _mm256_unpackhi_epi64(a0,a1);
      return _mm256_permute4x64_epi64(l, 0xD8);
    }
  };
} } }
