...
{
  #define M0(z,n,t)                                    \
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::Maxexponent,maxexponent, n) \
  /**/
...
namespace nt2 { namespace ext
{
  ...
  struct  value_type<tag::Maxexponent,Domain,N,Expr>
        : meta::generative_value<Expr>
  {};

  /// INTERNAL ONLY
  template<typename Domain, typename Expr, int N>
  struct  size_of<tag::Maxexponent,Domain,N,Expr>
