...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_MONEO_6_HPP_INCLUDED
...
{
  #define M0(z,n,t)                                    \
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::Moneo_6,moneo_6, n) \
  /**/
...
namespace nt2 { namespace ext
{
  ...
  struct  value_type<tag::Moneo_6,Domain,N,Expr>
        : meta::generative_value<Expr>
  {};

  /// INTERNAL ONLY
  template<typename Domain, typename Expr, int N>
  struct  size_of<tag::Moneo_6,Domain,N,Expr>
