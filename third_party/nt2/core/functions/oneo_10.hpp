...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_ONEO_10_HPP_INCLUDED
...
{
  #define M0(z,n,t)                                    \
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::Oneo_10,oneo_10, n) \
  /**/
...
namespace nt2 { namespace ext
{
  ...
  struct  value_type<tag::Oneo_10,Domain,N,Expr>
        : meta::generative_value<Expr>
  {};

  /// INTERNAL ONLY
  template<typename Domain, typename Expr, int N>
  struct  size_of<tag::Oneo_10,Domain,N,Expr>
