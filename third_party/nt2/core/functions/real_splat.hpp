...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_REAL_SPLAT_HPP_INCLUDED
...
{
  #define M0(z,n,t)                                    \
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::Real_splat,real_splat, n) \
  /**/
...
namespace nt2 { namespace ext
{
  ...
  struct  value_type<tag::Real_splat,Domain,N,Expr>
        : meta::generative_value<Expr>
  {};

  /// INTERNAL ONLY
  template<typename Domain, typename Expr, int N>
  struct  size_of<tag::Real_splat,Domain,N,Expr>
