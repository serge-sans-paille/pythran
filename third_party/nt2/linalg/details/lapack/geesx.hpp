...
//==============================================================================
#ifndef NT2_LINALG_DETAILS_LAPACK_GEESX_HPP_INCLUDED
#define NT2_LINALG_DETAILS_LAPACK_GEESX_HPP_INCLUDED
...
#define NT2_GEESX(NAME, T, TBASE)                                \
    ...
    {                                                            \
      ...
      NT2_F77NAME( NAME )(jobvs, sort, select, sense, n,         \
                          ...
                          rconde, rcondv, w.main(), query(),     \
                          w.reals(), w.logicals(), info);        \
...
#define NT2_GEESX(NAME, T)                                              \
      ...
      {                                                                 \
        ...
        NT2_F77NAME( NAME )(jobvs, sort, select, sense,                 \
                        ...
                        query(), w.integers(), &liwork,                 \
                        w.logicals(), info);                            \
        nt2_la_int wn = w.main_need();                                  \
        nt2_la_int wint = w.integers_need();                            \
