...
//==============================================================================
#ifndef NT2_REDUCTION_FUNCTIONS_COMPARE_LESS_EQUAL_HPP_INCLUDED
...
namespace nt2
{
  ...
  {
    #ifdef DOXYGEN_ONLY
    /*! \brief Same as \classref{boost::simd::tag::compare_less_equal_} **/
  ...
  #ifdef DOXYGEN_ONLY
  /*! \brief Same as \funcref{boost::simd::compare_less_equal} **/
  template<class... Args>
  details::unspecified compare_less_equal(Args&&... args);
  #endif
