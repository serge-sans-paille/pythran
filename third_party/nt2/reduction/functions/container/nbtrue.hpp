...
namespace nt2 { namespace ext
{
  ...
  {
    typedef typename meta::call <tag::if_one_else_zero_(A0 const &) >::type T1;
    typedef typename meta::call <tag::real_(T1)>::type                      T2;
    typedef typename meta::call <tag::sum_(T2)>::type           T3; //  result_type;
    typedef T3 result_type;
    BOOST_FORCEINLINE result_type operator()(A0 const& a0) const
    {
      return nt2::sum(nt2::real(nt2::if_one_else_zero(a0)));
    }
  };
                            ...
                            )
  {
    typedef typename meta::call <tag::if_one_else_zero_(A0 const &) >::type T1;
    typedef typename meta::call <tag::real_(T1)>::type                      T2;
    typedef typename meta::call <tag::sum_(T2, const A1&)>::type   result_type;
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, const A1& a1) const
    {
      return  nt2::sum(nt2::real(nt2::if_one_else_zero(a0)), a1);
    }
  };
} }
